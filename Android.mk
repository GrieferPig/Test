...
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := constraint-layout-solver:app/src/main/lib/constraint-layout-solver-1.0.2.jar
# define build aar dep
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES += constraint-layout:app/src/main/lib/constraint-layout-1.0.2.aar
